...
- Train station data is taken from the [Dienststellen Datensatz](https://data.opentransportdata.swiss/dataset/service-point-v2), by the [Geschäftsstelle Systemaufgaben Kundeninformation (SKI)](https://oev-info.ch) hosted at [opentransportdata.swiss](https://opentransportdata.swiss)
